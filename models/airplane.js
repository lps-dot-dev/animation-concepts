...
const createAirplane = (groupName, startingPoint = new DOMPoint()) => {
  ...
  W.cube({n: groupName + bladeSuffix + "0", g: groupName, b: Colors.brownDark, w: 0.1, h: propellerHeight, d: bladeDepth, x: cabinWidth + engineWidth + propellerWidth, y: cabinHeight / 3, z: -(bladeDepth / 64)});
  W.cube({n: groupName + bladeSuffix + "1", g: groupName, b: Colors.brownDark, w: 0.1, h: propellerHeight, d: bladeDepth, x: cabinWidth + engineWidth + propellerWidth, y: cabinHeight / 3, z: bladeDepth});
